...
def banner():
    print("\n%s    _________ __     \n%s   / ____/ (_) /____  ║ %sAuthor: %sShinzy %s& %sWa:085740559154\n%s  / __/ / / / __/ _ \ ║ %sFB %s: %sFacebook.com/1000xxxx\n%s / /___/ / / /_/  __/ ║ %sFB %s: %sZainul Umam\n%s/_____/_/_/\__/\___/  ║ %sGithub %s: %sGithub.com/Shin24\n"%(O,O,P,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
def menu_log():
...
def menu():
    ...
    print('%s╠══[%s•%s] %sName : ZAINUL UMAM%s'%(O,P,O,P,users))
    print('%s╠══[%s•%s] %sEmail : ekaarsana89@gmail.com%s'%(O,P,O,P,maile))
